...
export default function ResumeBuilderPage() {
  ...
  const [builderUrl] = useState<string>("/resume-engine/index.html?v=2");
        ...
        {hasError && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-50 z-10 p-6 text-center">
            ...
            <p className="text-xs text-slate-500 max-w-md mb-4">
              Please ensure the backend API server is running on port 8000 or configure NEXT_PUBLIC_BACKEND_URL.
            </p>
            <button
              onClick={() => {
                setHasError(false);
